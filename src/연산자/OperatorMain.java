...
// 증감연산자 : ++, --, 단항연산자, 변수의 값을 1증가 혹은 1감소시키는 연산자
...
public class OperatorMain {
    public static void main(String[] args) {
        ...
        System.out.println(x - y);
        System.out.println(x * y);
        System.out.println(x / y); // 나눗셈이 아닌 몫을 구함 (소수점은 고려 안하기 때문)
        System.out.println((double) x / y); // 나눗셈을 위해 명시적 형변환
        System.out.println(x % y); // 나머지

        // 대입연산자
        int num1 = 10; // 정수타입의 num1 변수에 10을 대입
        ...
        System.out.println(num2++); // 선대입 후증가
        ...
        // 논리연산자
        int num5 = 10, num6= 20;
        System.out.println(num5 > 0 && num5 > num6); // 산술연산자가 논리연산자보다 우선순위가 높음, false
        System.out.println(num5 > 0 || num5 > num6); // 좌항의 조건이 참이므로 true
        System.out.println(!(num5 > 0 || num5 > num6)); // false

        // 3항연산자 : 참과 거짓만 있는 조건문 대체
        Scanner sc = new Scanner(System.in);
        System.out.print("나이 입력 : ");
        int age = sc.nextInt(); // 스캐너 객체로부터 나이를 입력받음
//        if (age >= 18){
