...
public class Television {
    ...
    // 접근 제한자 : private, defaul(생략 가능), protected, public
    ...
    // setter 메서드 : 외부에서 접근 불가능한 인스턴스 필드의 값을 변경하기 위해 사용하는 메서드
    public void setPower(boolean power) {
        this.power = power;  // 매개변수 이름과 인스턴스 필드 이름이 동일하면 this 키워드 사용
    ...
    public void setChannel(int channel) {
        ...
        System.out.println("채널을 " + channel + "으로 설정합니다.");
    }
