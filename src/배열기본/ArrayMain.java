...
public class ArrayMain {
    public static void main(String[] args) {
        ...
        // 총점 구하기
        int total = 0;
        for (int e : score){ // 향상된 for문, 이터러블 객체를 자동으로 순회, 배열 내부의 값을 변경할 수 없으며 무조건 처음부터 끝까지 순회
