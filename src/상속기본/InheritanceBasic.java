package 상속기본;
// 상속 : 부모클래스의 유산(필드, 메서드)을 자식클래스에게 물려 주는 것
// - 재사용성을 위해서 주로 사용, 상속받은 기능을 변경하면 오버라이딩 (다형성)
// - extends 상속을 받을 때 사용하는 키워드
// 자식클래스는 부모클래스의 모든 내용을 포함하고 있기 때문에 같거나 크다
// 오버라이딩은 매개변수, 리턴 값이 모두 같아야 함 (오버로딩은 매개변수(개수나 타입)의 차이로 구현, 리턴값만 다르면 오버로딩 X)
